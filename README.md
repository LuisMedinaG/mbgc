...
> **iOS app moved.** The SwiftUI iOS app now lives in its own repo:
> [LuisMedinaG/mbgc-ios](https://github.com/LuisMedinaG/mbgc-ios) (split out 2026-07-01).
...
- [LuisMedinaG/mbgc-ios](https://github.com/LuisMedinaG/mbgc-ios) — SwiftUI iOS app (separate repo)
