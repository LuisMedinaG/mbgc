---
name: sync-docs
description: Update AGENTS.md and AGENTS.md to reflect uncommitted changes or decisions made during a conversation. Use when asked to "sync docs", "update the agents file", "keep docs up to date", or after any architectural change, new convention, or environment update.
---

# Sync Docs

Keeps `AGENTS.md` and `AGENTS.md` in sync with the current state of the codebase.
...
### Per-service AGENTS.md files

Each service has `services/<name>/AGENTS.md`. Update when:
...
4. Verify no info is duplicated between AGENTS.md and AGENTS.md

## What NOT to put in AGENTS.md

- File paths that change often (use service AGENTS.md instead)
- Implementation details (use skill files or service AGENTS.md)
